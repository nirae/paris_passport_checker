        ...
        with self.site.client:
            while True:
                ...
                for slot in slots:
                    ...
                    message = f"Slot found {slot['location']}, {slot['address']} at <b>{date}</b> https://teleservices.paris.fr/rdvtitres/jsp/site/Portal.jsp?page=appointmentsearch&view=search&category=titres"
